...
def usage():
    test="name"
    message='''
python TEMP2GFF.py --insertion /rhome/cjinfeng/software/tools/TEMP/test_dataset/test_chromosome.insertion.refined.bp.summary
...
def main():
    ...
    insertion2gff(args.insertion, args.project)
    #absence2gff(args.absence)
